...
<template>
    <div class="min-h-screen bg-transparent flex flex-col font-sans relative overflow-hidden">
        ...
        <nav class="fixed w-full z-50 glass dark:border-gray-800 transition-all duration-300">
                ...
                <div class="flex justify-between h-20 items-center">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        <a v-for="item in navigation" :key="item.name" :href="item.href"
                            class="text-gray-600 dark:text-gray-300 hover:text-brand-600 dark:hover:text-brand-400 font-medium transition-colors">
                            {{ item.name }}
                        </a>
                        ...
                        <Link href="/contact" class="bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 rounded-full font-medium transition-all transform hover:scale-105 shadow-md hover:shadow-brand-500/30">
            ...
            <!-- Mobile Menu -->
            <div v-show="isMenuOpen" v-motion-fade class="md:hidden glass-dark dark:bg-gray-900 absolute w-full left-0 origin-top">
